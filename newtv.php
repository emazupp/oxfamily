	...
	<body>
		...
		<nav class="navbar" id="nav">
			...
			<div class="nav_container">
				<div class="nav_elements">
					...
					<li class="active"> <a class="elements" href="newtv.php"> New serie </a> </li>
		...
		<div id="main_form_wrap">
			...
			<div id="container_form_wrap">
				<form id="create_form_body" action="processes/uploadtv.php" method="post" enctype="multipart/form-data">
					<h1 class="h1_newanime"> Aggiungi nuova serie</h1>
					...
					<div id="field_separator">
						<?php 
							if(isset($_GET["success_file_uploaded"]))
								echo "<span class=\"success_file_uploaded\">Serie tv caricato con successo. </span>"; 
				...
				<form id="edit_form_body" action="processes/edittv.php" method="post" enctype="multipart/form-data">
					<h1 class="h1_newanime"> Modifica serie</h1>
					<div id="field_separator">
					<label id="form_field_label"> Titolo </label>
					   <select class="select_new" name="title" onchange='location = "newtv.php?selected_title="+this.value;'>
									<option selected disabled value="empty"> Seleziona </option>
									<?php
										$sql = "SELECT Titolo,trailer,img_name FROM $serietv ORDER BY Titolo";
