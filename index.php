...
?>
	...
	<body>
		...
		<nav id="nav" class="navbar">
			...
			<div class="nav_container">
				<div class="nav_elements">
					<li class="active"><a class="elements" href="index.php">Anime</a></li>
		...
		<div id="main_wrap">
			...
			<!-- <div align="center">
				<input type="text" id="myInput" placeholder="Ricerca il titolo..." title="Type in a name"> </input>
			</div> -->
			<?php
				function getVotes($result, $utenti, $votare, $anime, $conn) {
					$lista_finale = "";
					$sql2 = "WITH cte AS ( SELECT v.* FROM $anime f JOIN $votare v ON v.Cod = f.Cod WHERE f.Titolo = '".$result["Titolo"]."') SELECT * FROM $utenti u LEFT JOIN cte ON cte.Id = u.Id ORDER BY voto DESC";
					/*$sql2 = "SELECT * FROM $utenti LEFT OUTER JOIN $votare ON $utenti.ID = $votare.ID
												  LEFT OUTER JOIN $anime ON votare.Cod = $anime.Cod
				...
				$sql = "SELECT ROUND(AVG(Voto),2) AS Media ,Titolo,img_name, $anime.Cod, trailer FROM $utenti INNER JOIN $votare ON $utenti.ID = $votare.ID
						RIGHT OUTER JOIN $anime ON $votare.Cod = $anime.Cod
					...
					do {
						...
						<div class=\"card\">
						  <div class=\"overlay\">
							...
							<img onclick= \"openmodal(".$result["Cod"].")\" id=\"".$result["Titolo"]."\"class=\"imgcard\" src=\"img/".$result["img_name"]."\">
							...
							<div id=\"".$result["Cod"]."\" class=\"modal\">
							  <div class=\"modal-content\">
								...
								<div id=\"votes_list\">
							    <h2>".$result["Titolo"]."</h2>".
								getVotes($result, $utenti, $votare, $anime, $conn)
								."</div>
